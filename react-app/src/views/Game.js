    ...
    <div className="column">
      <div className="box is-clickable" @click="pictureClicked">
       ...
       <ul className="panel">
        ...
        <li v-for="(c, i) in game.Captions_In_Play" :key="i" className="panel-block is-active">
          <div className="is-expanded">{{c.text}}</div>
          <span className="tag " :className=" game.Caption_Chose > -1 ? 'is-primary' : 'is-light'">{{c.player}}</span>
